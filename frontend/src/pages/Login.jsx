        ...
        <div className="auth-page">
            ...
            <div className="auth-card">
                ...
                <div className="auth-card-header">
                    ...
                    <p className="auth-card-sub">Sign in to your intelligence platform</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="auth-form-grid">
                    ...
                    <div className="auth-field">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                            ...
                            <NavLink to="/forgot-password" className="auth-forgot">Forgot password?</NavLink>
                        </div>
                        <div className="auth-input-wrapper">
                ...
                <div className="auth-divider">
                    ...
                    <NavLink to="/register" className="auth-link">Create an account</NavLink>
                </div>
            </div>
        </div>
    );
